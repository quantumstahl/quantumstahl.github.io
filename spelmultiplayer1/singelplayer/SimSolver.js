...
const SimSolver = {
    ...
    step(game) {
        ...
        for (let i = 0; i < solids.length; i++) {
            ...
            o._triggered = false;
            o._wantdx = o.x - o.freex;   
            o._wantdy = o.y - o.freey; 
            o.x = o.freex;
            o.y = o.freey;
...
if (isAxisAlignedRot(d.r)) {
  ...
  markStaticsDirty(){ _statStamp++;gamee.needsPathRebuild = true; },  // call when you move/rate/add/remove statics
  markGhostsDirty(){  _ghostStamp++; } // call when ghost volumes change
};
